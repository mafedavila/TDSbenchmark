...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Evaluate classifiers on synthetic datasets")
    ...
    parser.add_argument("ds_model", type=str, help="The name of the TDS model")
    parser.add_argument("performance_dir", type=str, help="Directory to save performance metrics")
    args = parser.parse_args()

    # print(f"Starting classifier evaluation for {args.ds_model} on dataset {args.dataset_name}")
    evaluate_all_datasets(args.predicted, args.dataset_name, args.ds_model, args.performance_dir)
