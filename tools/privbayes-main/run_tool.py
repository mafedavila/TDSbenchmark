...
import torch
import json
from synthesis.synthesizers.privbayes import PrivBayes # PrivBayes implementation from https://github.com/daanknoors/synthetic_data_generation/tree/master
...
def train_model(data, dataset_path, experiment):
    ...
    model = PrivBayes(epsilon=epsilon, verbose=False)
...
def generate_synthetic_data(model, data):
    ...
    synthetic_data = model.sample(n_records=5000)
